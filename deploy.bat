...
REM
REM  2026-09-10: author_allowlist.json je NOVY soubor (pise ho sync_airtable.py
REM  z tabulky Authors, pole Bio_Studies). `git add -u` ho nepobere, protoze
REM  neni tracked -- a bez nej build_pages.py spadne zpet na authorIndex a tri
REM  medailonky zacnou zas pripisovat cizi praci. Proto stoji v seznamu nize.
