...
# ---- mtorc2: why does one kinase need two complexes? -------------------
 ...
 "aa": [
  ...
  {"interaction": "RHEB-MTORC1",
   "what": "Rheb switches mTORC1 on – and nutrients do not control Rheb.",
...
LOOP_RULES = [
 ("S6K1-IRS1",   "S6K1 → IRS-1 feedback",
  "The pathway's most clinically consequential loop. mTORC1 drives S6K1, S6K1 degrades IRS-1, and PI3K signalling falls. Block mTORC1 and IRS-1 is spared, so Akt reactivates – a large part of the reason rapalog monotherapy underperforms."),
