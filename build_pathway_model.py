...
TEACH = {
 ...
 "SESN2-AGING": "The arrow lands on the Longevity node because this map has no separate node for age-related pathology, but LEE2010 measured pathology in flies, not survival. Read it as the sensor arm's only organismal readout, not as evidence that Sestrin2 extends life. The node it points at is a limitation of the graph, not a claim about lifespan.",
 "MTORC1-SENESCENCE": "Read the sign as geroconversion and the SASP, not as 'mTORC1 makes cells senescent'. LAB2015 shows mTORC1 promoting IL1A translation in cells that are already arrested, and rapamycin suppressing the secretome while the arrest stays. Senescence and SASP are separate claims; conflating them is the commonest misreading of this edge.",
...
MECH_BEGINNER = {
 ...
 "EVE-IMMUNE": "At a low, occasional dose, an mTOR-blocking drug helped older people respond better to a flu vaccine. At the high continuous dose used after transplants, the same drug class damps the immune system down. A larger follow-up trial did not find fewer infections – so what this arrow means depends on the dose.",
...
# ---- mtorc2: why does one kinase need two complexes? -------------------
 ...
 "exercise": [
  {"interaction": "LOAD-MTORC1",
   ...
   "certainty": "The strongest evidence in this entire section: a human interventional study (DRU2009, H – human), supported by rodent genetics (BOD2001) and pharmacology (ZHO2009). Human relevance ESTABLISHED, not plausible.",
